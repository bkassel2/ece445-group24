...
We noticed that we needed some additional surface mount components for the PCB such as resistors and capacitors as well as Molex connectors for the PS/2 headers, and filled out order forms for them.
